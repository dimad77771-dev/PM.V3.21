...
// Type: DevExpress.Xpf.Data.RowTypeDescriptorListIndex
...
namespace DevExpress.Xpf.Data
{
  public class RowTypeDescriptorListIndex : RowTypeDescriptorBase
  {
    ...
    private GridDataProvider GridOwner
    {
      get
      {
        return (GridDataProvider) this.Owner;
      }
    }
    ...
    {
      return this.GridOwner.GetRowValueByListIndex(this.listIndex, info);
    }
    ...
    {
      return this.GridOwner.GetRowValueByListIndex(this.listIndex, fieldName);
    }
  }
}
