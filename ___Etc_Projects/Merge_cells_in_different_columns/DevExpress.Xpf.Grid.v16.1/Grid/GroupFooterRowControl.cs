...
// Type: DevExpress.Xpf.Grid.GroupFooterRowControl
...
namespace DevExpress.Xpf.Grid
{
  public class GroupFooterRowControl : ContentControl
  {
    ...
    public override void OnApplyTemplate()
    {
      ...
      this.GroupFooterContentPresenter = this.GetTemplateChild("PART_GroupFooterContentPresenter") as FrameworkElement;
    }
  }
}
