...
// Type: DevExpress.Xpf.Grid.TreeList.TreeListDisplayTextPropertyDescriptor
...
namespace DevExpress.Xpf.Grid.TreeList
{
  public class TreeListDisplayTextPropertyDescriptor : PropertyDescriptor
  {
    ...
    {
      return (object) this.DataProvider.View.GetNodeDisplayText(node, this.Name, this.DataProvider.View.GetNodeValue(node, this.Name));
    }
