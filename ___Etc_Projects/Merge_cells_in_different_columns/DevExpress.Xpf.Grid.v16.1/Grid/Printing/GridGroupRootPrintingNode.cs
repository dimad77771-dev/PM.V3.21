...
// Type: DevExpress.Xpf.Grid.Printing.GridGroupRootPrintingNode
...
{
  public class GridGroupRootPrintingNode : GridContainerPrintingNodeBase, IVisualGroupNodeFixedFooter, IVisualGroupNode, IGroupNode, IDataNode
  {
    ...
    {
      if (this.TreeBuilder.PrintView.PrintTotalSummary && this.TreeBuilder.View.ShowTotalSummary && this.TreeBuilder.PrintFooterTemplate != null)
    ...
    {
      if (this.TreeBuilder.PrintHeaderTemplate != null)
    ...
    {
      if (this.TreeBuilder.PrintView.PrintFixedTotalSummary && this.TreeBuilder.View.ShowFixedTotalSummary && this.TreeBuilder.PrintFixedFooterTemplate != null)
