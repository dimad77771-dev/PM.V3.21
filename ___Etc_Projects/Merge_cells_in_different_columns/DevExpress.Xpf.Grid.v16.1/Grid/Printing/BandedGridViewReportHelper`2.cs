...
// Type: DevExpress.Xpf.Grid.Printing.BandedGridViewReportHelper`2
...
{
  public class BandedGridViewReportHelper<TCol, TRow> : AdvBandedGridViewExportHelper<TCol, TRow>, IAdvancedBandedGridView<TCol, TRow>, IBandedGridView<TCol, TRow>, IGridView<TCol, TRow>, IGridViewBase<TCol, TRow, TCol, TRow> where TCol : ColumnWrapper where TRow : RowBaseWrapper
  {
    ...
    public BandedGridViewReportHelper(TableView view, ExportTarget target)
      : base(view, target)
    {
