...
// Type: DevExpress.Xpf.Grid.GroupSummaryContentPresenter
...
namespace DevExpress.Xpf.Grid
{
  public class GroupSummaryContentPresenter : GridDataContentPresenter, IDefaultGroupSummaryItem
  {
    GridGroupSummaryData IDefaultGroupSummaryItem.ValueData
    {
      get
      {
        return this.Content as GridGroupSummaryData;
      }
      set
      {
    ...
    public GroupSummaryContentPresenter()
    {
      ...
      GridViewHitInfoBase.SetHitTestAcceptor((DependencyObject) this, (DataViewHitTestAcceptorBase) new GroupSummaryTableViewHitTestAcceptor());
    }
  }
}
