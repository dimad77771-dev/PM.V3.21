...
// Type: DevExpress.Xpf.Grid.HitTest.ColumnEdgeTableViewHitTestAcceptor
...
namespace DevExpress.Xpf.Grid.HitTest
{
  public class ColumnEdgeTableViewHitTestAcceptor : TableViewHitTestAcceptorBase
  {
    ...
    {
      visitor.VisitColumnEdge(BaseGridHeader.GetGridColumn((DependencyObject) LayoutHelper.FindParentObject<BaseGridHeader>((DependencyObject) element)));
    }
  }
}
