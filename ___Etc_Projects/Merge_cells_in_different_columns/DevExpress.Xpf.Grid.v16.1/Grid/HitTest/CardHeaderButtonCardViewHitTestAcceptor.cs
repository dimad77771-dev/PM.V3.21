...
// Type: DevExpress.Xpf.Grid.HitTest.CardHeaderButtonCardViewHitTestAcceptor
...
namespace DevExpress.Xpf.Grid.HitTest
{
  public class CardHeaderButtonCardViewHitTestAcceptor : CardViewHitTestAcceptorBase
  {
    ...
    {
      visitor.VisitCardHeaderButton(DataViewHitTestAcceptorBase.GetRowHandleByElement(element));
    }
  }
}
