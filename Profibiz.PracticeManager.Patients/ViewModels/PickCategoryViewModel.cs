...
{
	[POCOViewModel]
	public class PickCategoryViewModel : ViewModelBase
	{
		#region Services
		...
		public virtual ObservableCollection<Category> SelectedEntities { get; set; } = new ObservableCollection<Category>();
		...
		public PickCategoryViewModel(IPatientsBusinessService _businessService, ILookupsBusinessService _lookupsBusinessService) : base()
		{
		...
		public static Task<ReturnParams> Pick(OpenParams parm)
		{
			...
			{
				ViewCode = ViewCodes.PickCategoryView,
				Param = parm,
			});
