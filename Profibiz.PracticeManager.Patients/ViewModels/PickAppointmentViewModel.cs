...
{
	[POCOViewModel]
	public class PickAppointmentViewModel : ViewModelBase
	{
		#region Services
		...
		public PickAppointmentViewModel(IPatientsBusinessService _businessService, ILookupsBusinessService _lookupsBusinessService) : base()
		{
			...
			Boolean multipleSelectionMode = false)
		{
			...
			showDXWindowsInteractionRequest.Raise(new ShowDXWindowsActionParam
			{
				ViewCode = ViewCodes.PickAppointmentView,
