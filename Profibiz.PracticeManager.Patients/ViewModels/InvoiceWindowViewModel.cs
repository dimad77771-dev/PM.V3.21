...
{
	[POCOViewModel]
	public class InvoiceWindowViewModel : ViewModelBase
	{
        #region Services
        ...
        public virtual InvoiceOneViewModel OneModel { get; set; } = InvoiceOneViewModel.Create(isWindowMode: true);


        public InvoiceWindowViewModel() : base()
		{
		}
		...
		async Task LoadData()
		{
            await OneModel.LoadData(
				...
				selectPaymentRowId: OpenParam.SelectPaymentRowId, 
				newInvoice: OpenParam.NewInvoice,
		...
		public class OpenParams
		{
            ...
            public Guid? SelectPaymentRowId { get; set; }
        }
