...
{
	[POCOViewModel]
	public class SupplierPaymentWindowViewModel : ViewModelBase
	{
		#region Services
		...
		public virtual SupplierPaymentOneViewModel OneModel { get; set; } = SupplierPaymentOneViewModel.Create();


		public SupplierPaymentWindowViewModel() : base()
		{
		}
		...
		async Task LoadData()
		{
			...
			await OneModel.LoadData(isNew: false, rowId: OpenParam.RowId, readOnly: true, selectOrderRowId: OpenParam.SelectOrderRowId);
		}
