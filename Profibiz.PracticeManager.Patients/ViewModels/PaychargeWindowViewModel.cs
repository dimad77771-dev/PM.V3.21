...
{
	[POCOViewModel]
	public class PaychargeWindowViewModel : ViewModelBase
	{
		#region Services
		...
		public virtual PaychargeOneViewModel OneModel { get; set; } = PaychargeOneViewModel.Create();


		public PaychargeWindowViewModel() : base()
		{
		}
		...
		async Task LoadData()
		{
			...
			await OneModel.LoadData(isNew: false, rowId: OpenParam.RowId, readOnly: true, selectChargeoutRowId: OpenParam.SelectChargeoutRowId);
		}
