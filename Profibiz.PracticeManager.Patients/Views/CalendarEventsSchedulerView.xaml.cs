...
{
    public partial class CalendarEventsSchedulerView : UserControl
    {
        public CalendarEventsSchedulerView()
        {
            InitializeComponent();
			...
			var viewmodel = DataContext as ViewModels.CalendarEventsSchedulerViewModel;
			...
			if (oldService != null)
			{
				var  newService = new MyCalendarEventFormatStringService(oldService);
			...
			//schedulerControl1.CalendarEventResized += SchedulerControl1_CalendarEventResized;
			//schedulerControl1.CalendarEventDrop += SchedulerControl1_CalendarEventDrop;
			...
			////k.ResourceKey = DevExpress.Xpf.Scheduler.ThemeKeys.SchedulerViewThemeKeys.VerticalCalendarEventTemplate;
			//k.ResourceKey = DevExpress.Xpf.Scheduler.ThemeKeys.SchedulerViewThemeKeys.HorizontalCalendarEventTemplate;
		...
		public class MyCalendarEventFormatStringService : AppointmentFormatStringServiceWrapper
		{
			...
			//	return TIME_FORMAT;
			//}
			//public override string GetVerticalCalendarEventEndFormat(ICalendarEventViewInfo aptViewInfo)
			//{
			//	return TIME_FORMAT2;
			//}
			...
			//public override string GetContinueItemStartFormat(ICalendarEventViewInfo aptViewInfo)
			//{
			//	return TIME_FORMAT;
			//}
			//public override string GetContinueItemEndFormat(ICalendarEventViewInfo aptViewInfo)
			//{
			//	return TIME_FORMAT;
			//}
		}
