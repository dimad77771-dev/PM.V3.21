...
namespace Profibiz.PracticeManager.InfrastructureExt.Properties {
...
<ArrayOfFilterInfo xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  ...
  <FilterInfo>
    ...
    <FilterCriteria>(Not IsNull([DueDate]))AND([DueDate] &lt; LocalDateTime?Now())AND(Not([Status] = ##Enum#DevExpress.DevAV.EmployeeTaskStatus,Completed#))</FilterCriteria>
    <ImageUri />
  </FilterInfo>
  <FilterInfo>
...
<ArrayOfFilterInfo xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  ...
  <FilterInfo>
    <Name>Last Year</Name>
    <FilterCriteria>GetYear([Date])=(GetYear(LocalDateTime?Now())-1)</FilterCriteria>
  </FilterInfo>
  <FilterInfo>
    <Name>This Year</Name>
